...
sealed class NavigationCommand {
    data class NavigateWithAction(val navAction: NavigationAction) : NavigationCommand()
    ...
    data class NavigateToUrlExternally(val httpLink: String) : NavigationCommand()
}