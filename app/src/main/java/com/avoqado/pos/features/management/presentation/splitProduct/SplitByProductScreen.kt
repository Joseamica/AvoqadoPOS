...
import com.avoqado.pos.features.management.presentation.tableDetail.AVProductItem
import com.avoqado.pos.features.management.presentation.tableDetail.ProductsScreen
...
fun SplitByProductContent(
    ...
    Column(
        ...
        Column(
            ...
            val buttonLabel = if (state.totalQuantitySelected == 0) {
