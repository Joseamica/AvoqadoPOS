...
fun TableDetailView.toDomain(): com.avoqado.pos.features.management.domain.models.TableDetail =
    com.avoqado.pos.features.management.domain.models.TableDetail(
        id = this.tableId,
        name = this.name,
        ...
        paymentOverview =
            this.paymentsDone.takeIf { it.isNotEmpty() }?.let {
...
fun Product.toDomain(): com.avoqado.pos.features.management.domain.models.Product =
    com.avoqado.pos.features.management.domain.models.Product(
        id = this.id,
        name = this.name,
        price = this.price,
